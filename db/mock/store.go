...
import (
	...
	sqlc "github.com/labasubagia/simplebank/db/sqlc"
...
func (m *MockStore) GetAccountsForUpdate(ctx context.Context, ids []int64) ([]sqlc.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountsForUpdate", ctx, ids)
	ret0, _ := ret[0].([]sqlc.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetAccountsForUpdate(ctx, ids interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountsForUpdate", reflect.TypeOf((*MockStore)(nil).GetAccountsForUpdate), ctx, ids)
}
...
func (mr *MockStoreMockRecorder) ListTransfer(ctx, arg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
